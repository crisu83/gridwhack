...
public abstract class NonPlayerUnit extends GridUnit
{	
	 ...
	 */
	public NonPlayerUnit(String filename, Grid grid) 
	{
		super(filename, grid);
		...
		// initialize the non-player unit.
		super.init();
	}
	 ...
	 */
	public Unit getClosestVisibleHostileUnit()
	{		
		Unit closest = null;
		int lowestCost= 0;
	...
	{
		// always attack the closest visible hostile unit.
		Unit target = getClosestVisibleHostileUnit();
	...
	protected void createLoot()
	{
		...
		grid.createLoot(this.getGridX(), this.getGridY(), loot);
	}
